...
public class UmCarroJa implements Serializable {
     ...
     */
     public void classificarCliente(Aluguer alug, int classif){
         ...
         double novaClassificacao = (classificAnterior + classif) / ((double)(nAlugs));
   ...
   public List<Aluguer> getAlugueresCliente(String mail) throws NaoEfetuouNenhumAluguerException {
       ...
       Collection<Map<String, List<Aluguer>>> lol= this.alugueres.values();
           for(Map<String, List<Aluguer>> a: lol) {
               for (List<Aluguer> mel : a.values()) {
                   for (Aluguer al : mel) {
